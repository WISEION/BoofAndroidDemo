...
![A burst of light and colour across the clouds](gallery/01-histogram-local-color-burst.png)

### Histogram Local · Color
![A sky that looks painted, like Van Gogh](gallery/02-histogram-local-color-vangogh-sky.png)

### Histogram · Color
![Rainbow colours hidden inside ordinary clouds](gallery/03-histogram-color-rainbow-clouds.png)

### Histogram Local · Color
![Deep blue hour over the rooftops](gallery/04-histogram-local-color-blue-hour.png)

### Histogram Global · Color
![Bright blue sky at the edge of sunset](gallery/05-histogram-global-color-blue-sky.png)
